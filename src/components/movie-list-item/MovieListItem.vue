<template>
  <li
    ...
    :class="[{ favoruite: movie.favoruite }, { like: movie.like }]"
  >
    <span
    ...
    <div class="d-flex justify-content-center align-item-center">
      <button
        ...
        @click="$emit('onToggle', { id: movie.id, prop: 'favoruite' })"
      >
...
.list-group-item.favoruite .list-group-item-label {
  color: #e09f3e;
}

.list-group-item.favoruite .list-group-item-input {
  color: #e09f3e;
}
</style>
